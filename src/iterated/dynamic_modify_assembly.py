...
from src.iterated.insert_site import insert_site
from src.iterated.cut_ctg_to3 import cut_ctg_to_three
from src.iterated.find_site_ctgs import find_site_ctgs
from src.iterated.move_ctgs import move_ctgs_toback
...
def adjust_errors(error_queue, hic_file, ratio, assembly_file, modified_assembly_file):
    ...
    for error in error_queue:
        logger.info("正在调整 {0} ".format(error))
