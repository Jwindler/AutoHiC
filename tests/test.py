...
from tests.deb_adjust_v3 import adjust_debris
from core.inv_adjust_v2 import adjust_inversion
from tests.tran_adjust_v3 import adjust_translocation
...
def adjust_all_error(hic_file_path, assembly_file_path, divided_error, modified_assembly_file):
    ...
    #                                        black_list_output="/home/jzj/Jupyter-Docker/buffer/black_list.txt",
    #                                        black_list="/home/jzj/Jupyter-Docker/buffer/old.txt")
...
def main():
    hic_file_path = "/home/jzj/Data/Elements/raw_hic_data/Np/Np.0.hic"
    assembly_file_path = "/home/jzj/Data/Elements/raw_hic_data/Np/Np.0.assembly"

    divided_error = "/home/jzj/Jupyter-Docker/buffer/Np_test"
