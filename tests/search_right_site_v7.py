...
@file: search_right_site_v7.py
@time: 2/20/23 5:35 PM
@function: 
"""
...
def search_right_site_v7(hic_file, assembly_file, ratio, error_site: tuple):
...
def main():
    error_site = (339480001, 340170001)
    ...
    ratio = 1
    print(search_right_site_v7(hic_file, assembly_file, ratio, error_site))
